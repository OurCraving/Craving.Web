...
function AppHelper() {
    ...
    var instance = this;
    var imageServer = "http://localhost:54991/";

    instance.getSafeAvatarImage = getSafeAvatarImage;
    ...
    instance.getSafePreviewImage = getSafePreviewImage;
    ...
    function getSafeAvatarImage(imgName) {
        ...
        if (imgName === "Mystery" || imgName === "" || imgName === undefined || imgName === null) {
            ...
            imgName = replaceAll(imgName, "\\", "/");
            imgName = imageServer + imgName;
        }
